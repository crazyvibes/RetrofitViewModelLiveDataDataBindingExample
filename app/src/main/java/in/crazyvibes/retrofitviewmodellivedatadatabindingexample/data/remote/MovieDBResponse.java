package in.crazyvibes.retrofitviewmodellivedatadatabindingexample.data.remote;
...
public class MovieDBResponse implements Parcelable
{
    ...
    protected MovieDBResponse(Parcel in) {
        ...
        in.readList(this.Movies, (in.crazyvibes.retrofitviewmodellivedatadatabindingexample.ui.model.Movie.class.getClassLoader()));
    }
